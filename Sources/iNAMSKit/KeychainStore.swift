...
/// Generic-password wrapper around the macOS Keychain. The app's API key
/// lives only here — never in UserDefaults or on disk.
public struct KeychainStore: Sendable {
    ...
    public init(service: String = "com.neo4j-labs.inams") {
